...
export default function Home() {
    return (
        <div className="min-h-screen mx-auto md:px-12 lg:px-24 lg:py-0 px-6 py-12">
            <div className="lg:flex lg:justify-between lg:gap-4">
                <div
                    className="lg:flex lg:sticky lg:top-0 lg:w-1/2 lg:flex-col lg:justify-between lg:py-24 lg:min-h-screen">
                    <div>
                ...
                <div className="pt-24 lg:w-1/2 lg:py-24">
                    <p className="mb-16 md:mb-24 lg:mb-36">self introduction</p>
                    <p className="mb-16 md:mb-24 lg:mb-36 whitespace-normal break-words">working experience</p>
